    ...
    public class MessagesController : ApiController
    {
        ...
        public async Task<Message> Post([FromBody]Message message)
        {
            if (message.Type == "Message")
            {
                ...
                if (message.Text.ToLower().Contains("amazon"))
                {
                    var result = "";
        ...
        {
            {new[] {"Virtual Machines", "Learning Path"}, "https://azure.microsoft.com/pt-br/documentation/learning-paths/virtual-machines/" },
            {new[] {"Create", "Virtual Machine", "Portal" }, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-hero-tutorial/" },
            {new[] {"PowerShell", "Virtual Machine", "Create" }, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-ps-create/" },
            {new[] {"Connect", "Login", "Virtual Machine" }, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-connect-logon/" },
            {new[] {"Create", "Virtual Machine", "ARM" }, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-ps-template/" },
            {new[] {"Sobre", "Virtual Machine" }, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-about/" },
            {new[] {"Virtual Machine", "Compare"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-compare-deployment-models/" },
            {new[] {"Virtual Machine", "Extension"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-extensions-features/" },
            { new[] {"Container", "Virtual Machine"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-containers/" },
            { new[] {"Scale", "Virtual Machine"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machine-scale-sets-overview/" },
            { new[] {"Size", "Virtual Machine"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-sizes/" },
            { new[] {"PowerShell", "Virtual Machine", "Create", "ARM"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-create-powershell/" },
            { new[] {"Virtual Machine", "Capture"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-capture-image/" },
            { new[] {"Upload", "Virtual Machine", "Image"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-upload-image/" },
            { new[] {"Copy", "Virtual Machine", "ARM"}, "https://azure.microsoft.com/pt-br/documentation/articles/virtual-machines-windows-specialized-image/" },
        ...
        private Dictionary<string, string> ActionsOfAzure = new Dictionary<string, string>
        {
            ...
            {"inicio", "Create" },
            {"start", "Create" },
            {"aprender", "learning-paths" },
            {"curso", "learning-paths" },
